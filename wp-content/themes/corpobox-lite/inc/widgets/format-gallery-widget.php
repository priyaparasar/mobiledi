 ...
 * @package Corpobox
 */
add_action('widgets_init', create_function('', 'register_widget("Corpobox_Post_Format_Gallery_Widget");'));

class Corpobox_Post_Format_Gallery_Widget extends WP_Widget {
    function __construct() {
        parent::WP_Widget('post_format_gallery_widget', 'Post Format Gallery', array('description'=>__('Post Format Gallery', 'corpobox') ));
    }
...
<?php
    ...
    function form($instance) {
        $defaults = array(
            'title' => __('Gallery', 'corpobox'), 
            'gallery' => __('Gallery', 'corpobox'), 
        );
